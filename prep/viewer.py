...
class Cube(Node):
    def __init__(self, shader):
        ...
        # self.add(*[mesh for mesh in load_textured('Fish/Barracuda/Barracuda2anim.obj', shader)])
        # self.add(*[mesh for mesh in load_textured('Fish/BlueStarfish/BluieStarfish.obj', shader)])
        # self.add(*[mesh for mesh in load_textured('Fish/BlueTang/BlueTang.obj', shader)])
        # self.add(*[mesh for mesh in load_textured('Fish/BottlenoseDolphin/BottleNoseDolphin.obj', shader)])
        # self.add(*[mesh for mesh in load_textured('Fish/ClownFish2/ClownFish2.obj', shader)])
        # self.add(*[mesh for mesh in load_textured('Fish/GiantGrouper/GiantGrouper.obj', shader)])
        # self.add(*[mesh for mesh in load_textured('Fish/LionFish/LionFish.obj', shader)])
        # self.add(*[mesh for mesh in load_textured('Fish/NurseShark/NurseShark.obj', shader)])
        # self.add(*[mesh for mesh in load_textured('Fish/ReefFish0/ReefFish0.obj', shader)])
        # self.add(*[mesh for mesh in load_textured('Fish/ReefFish3/ReefFish3.obj', shader)])
        # self.add(*[mesh for mesh in load_textured('Fish/ReefFish4/ReefFish4.obj', shader)])
        # self.add(*[mesh for mesh in load_textured('Fish/ReefFish5/ReefFish5.obj', shader)])
        # self.add(*[mesh for mesh in load_textured('Fish/ReefFish7/ReefFish7.obj', shader)])
        # self.add(*[mesh for mesh in load_textured('Fish/ReefFish8/reeffish8.obj', shader)])
        # self.add(*[mesh for mesh in load_textured('Fish/ReefFish12/ReefFish12.obj', shader)])
        # self.add(*[mesh for mesh in load_textured('Fish/ReefFish14/reeffish14.obj', shader)])
        # self.add(*[mesh for mesh in load_textured('Fish/ReefFish16/ReefFish16.obj', shader)])
        # self.add(*[mesh for mesh in load_textured('Fish/ReefFish17/reeffish17.obj', shader)])
        # self.add(*[mesh for mesh in load_textured('Fish/ReefFish20/reeffish20.obj', shader)])
        # self.add(*[mesh for mesh in load_textured('Fish/SeaHorse/SeaHorse.obj', shader)])
        # self.add(*[mesh for mesh in load_textured('Fish/SeaSnake/seasnake.obj', shader)])
        # self.add(*[mesh for mesh in load_textured('Fish/TinyYellowFish/TinyYellowfish.obj', shader)])
        # self.add(*[mesh for mesh in load_textured('Fish/WhaleShark/WhaleShark.obj', shader)])
        self.add(*[mesh for mesh in load_textured('Fish/YellowTang/yellowtang.obj', shader)])
